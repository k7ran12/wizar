...
<body>
    <div class="container">
        ...
        <p>En PARRAL, a 29 de enero de 2023.</p>
        <div>
            <p class="sin_margin">Entre TRANSPORTES DEY SPA C.I. N° 77.349.008-2 domiciliado para estos efectos en ARTURO PRAT 2170B, COMUNA CONCEPCION, REGION DE MAULE representado por ESTEBAN ANDRES GOMEZ RAMOS C.I. N° 13.954.979-1 como VENDEDOR Y MANUEL JOSE ESPINAZA MEZA C.I. N° 7.751.677-8 domiciliado para estos efectos en INDEPENDENCIA 720, COMUNA RETIRO como COMPRADOR se ha convenido el siguiente contrato de compraventa:</p>
            <p class="con_margin">PRIMERO. - TRANSPORTES DEY SPA vende a MANUEL JOSE ESPINAZA MEZA quien compra y acepta para sí un vehículo Inscripción : JK.2374-8 DATOS DEL VEHICULO Tipo Vehículo : SEMIREMOLQUE Año : 2011 Marca : HSV SA Modelo : RPL 12 2011 Nro. Chasis : RPL-4-12-2012 Nro. Serie : RPL-4-12-2012 Color : GRIS Combustible : (NO INFORMADO) PBV : 45.000,00 KILOS, con sus accesorios completos que el comprador declara haber recibido a su entera satisfacción, y después de haberlo revisado detenidamente por lo que se expresa no tener cargo alguno ni objeción de formular, declarando que renuncia expresamente a las acciones de saneamiento por vicios redhibitorios establecido en el párrafo 8 del Título XXIII del Libro IV del Código Civil. El vehículo se vende en el estado en que se encuentra y que el comprador conoce cabalmente.</p>
