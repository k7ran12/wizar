...
<body>
    <div class="container">
        ...
        <p>En <strong>Parral</strong>, a 29 de enero de 2023.</p>
        <div>
            <p class="sin_margin">Entre <strong>GUACOLDA MERCIDA MALDONADO MALDONADO</strong> C.I. N° <strong>5.006.061-6</strong> domiciliado para estos efectos en <strong>RIO CLARO NRO.201</strong>, COMUNA <strong>CABRERO</strong>, REGION DE MAULE representado por <strong>LUIS HERNAN MORAGA HERRERA</strong> C.I. N° <strong>10.821.713-8</strong> como VENDEDOR Y TRANSPORTES <strong>LUIS HERNAN MORAGA HERRERA</strong> E.I.R.L. C.I. N° <strong>76.692.877-3</strong> domiciliado para estos efectos en EL PORTAL NRO.<strong>410</strong> VILLA LOS NARANJOS, COMUNA <strong>CHILLAN VIEJO</strong>, representado por <strong>{{ $documento->comprador->nombre }}</strong> C.I. N° <strong>{{ $documento->comprador->run }}</strong> como COMPRADOR se ha convenido el siguiente contrato de compraventa:</p>
            <p class="con_margin">PRIMERO. - <strong>GUACOLDA MERCIDA MALDONADO MALDONADO</strong> vende a TRANSPORTES <strong>{{ $documento->comprador->nombre }}</strong> E.I.R.L. quien compra y acepta para sí un vehículo Inscripción : <strong>{{ $documento->vehiculo->inscripcion }}</strong> Tipo Vehículo : <strong>{{ $documento->vehiculo->tipo_vehiculo }}</strong> Año : <strong>{{ $documento->vehiculo->anio }}</strong> Marca : <strong>{{ $documento->vehiculo->marca }}</strong> Modelo : <strong>{{ $documento->vehiculo->modelo }}</strong> Nro. Chasis : <strong>{{ $documento->vehiculo->chasis }}</strong> Color : <strong>{{ $documento->vehiculo->color }}</strong>, con sus accesorios completos que el comprador declara haber recibido a su entera satisfacción, y después de haberlo revisado detenidamente por lo que se expresa no tener cargo alguno ni objeción de formular, declarando que renuncia expresamente a las acciones de saneamiento por vicios redhibitorios establecido en el párrafo 8 del Título XXIII del Libro IV del Código Civil. El vehículo se vende en el estado en que se encuentra y que el comprador conoce cabalmente.</p>
            ...
            <p class="con_margin">SEXTO. - El vendedor declara expresa y juradamente, en forma individual, que ha firmado el presente instrumento, encontrándose físicamente dentro de los límites territoriales y geográficos de la comuna de <strong>PARRAL</strong> Región <strong>MAULE</strong> lo cual le consta fehacientemente por conocer los límites de la comuna referida.</p>
