...
<body>
    <div class="container">
        ...
        <p>En «CIUDAD», a 29 de enero de 2023.</p>
        <div>
            <p class="sin_margin">Entre GUACOLDA MERCIDA MALDONADO MALDONADO C.I. N° 5.006.061-6 domiciliado para estos efectos en RIO CLARO NRO.201, COMUNA CABRERO, REGION DE MAULE representado por LUIS HERNAN MORAGA HERRERA C.I. N° 10.821.713-8 como VENDEDOR Y TRANSPORTES LUIS HERNAN MORAGA HERRERA E.I.R.L. C.I. N° 76.692.877-3 domiciliado para estos efectos en EL PORTAL NRO.410 VILLA LOS NARANJOS, COMUNA CHILLAN VIEJO, representado por LUIS HERNAN MORAGA HERRERA C.I. N° 10.821.713-8 como COMPRADOR se ha convenido el siguiente contrato de compraventa:</p>
            <p class="con_margin">PRIMERO. - GUACOLDA MERCIDA MALDONADO MALDONADO vende a TRANSPORTES LUIS HERNAN MORAGA HERRERA E.I.R.L. quien compra y acepta para sí un vehículo Inscripción : JA.2584-7 Tipo Vehículo : REMOLQUE Año : 1995 Marca : OSGAR Modelo : NO REGISTRA Nro. Chasis : S/N Color : CELESTE, con sus accesorios completos que el comprador declara haber recibido a su entera satisfacción, y después de haberlo revisado detenidamente por lo que se expresa no tener cargo alguno ni objeción de formular, declarando que renuncia expresamente a las acciones de saneamiento por vicios redhibitorios establecido en el párrafo 8 del Título XXIII del Libro IV del Código Civil. El vehículo se vende en el estado en que se encuentra y que el comprador conoce cabalmente.</p>
            <p class="con_margin">SEGUNDO. - El precio de venta es la suma de $1.000.000.- (UN MILLON DE PESOS) que el comprador paga de la siguiente forma: $ 1.000.000.- en EFECTIVO. Con una tasación fiscal de $ 1.000.000.- (UN MILLON DE PESOS)</p>
            ...
            <p class="con_margin">SEXTO. - El vendedor declara expresa y juradamente, en forma individual, que ha firmado el presente instrumento, encontrándose físicamente dentro de los límites territoriales y geográficos de la comuna de PARRAL Región REGION DE MAULE  lo cual le consta fehacientemente por conocer los límites de la comuna referida.</p>
        ...
        <div class="firma">
            <table>
                <tr>
                    ...
                    <td>«NOMBRE_REPRESENTANTE_COMPRADOR»</td>
                </tr>
                <tr>
                    <td>C.I. N° «RUT_VENDEDOR»</td>
                    <td>C.I. N°</td>
                </tr>
                <tr>
                    <td>«RUT_REP_COMPRADOR»</td>
                    <td>C.P. «RUT_COMPRADOR»</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
