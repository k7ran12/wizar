...
@section('content')
        ...
        <div class="container mt-3">
            <form action="{{ route('documento.update', $documento->id) }}" method="post">
                @csrf
                @method('PUT')
                <input type="hidden" value="{{ $documento->propietario_vehiculo_id }}" name="propietario_vehiculo_id"
                    id="propietario_vehiculo_id">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $documento->fecha_creacion }}" name="fecha_creacion"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $documento->num_inscripcion }}" name="num_inscripcion"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $documento->rut_comprador }}" name="rut_comprador"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select name="estado" class="form-select" aria-label="Default select example">
                                                <option value="1" @if ($documento->estado == 1) selected @endif>
                                                    Activo</option>
                                                <option value="0" @if ($documento->estado == 0) selected @endif>
                                                    Inactivo</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="d-grid gap-2">
                                            <button style="margin-top: 7%" class="btn btn-success"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Año</label>
                                            <input value="{{ $documento->vehiculo->anio }}" name="anio"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Marca</label>
                                            <input value="{{ $documento->vehiculo->marca }}" name="marca"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Modelo</label>
                                            <input value="{{ $documento->vehiculo->modelo }}" name="modelo"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>N° Motor</label>
                                            <input value="{{ $documento->vehiculo->num_motor }}" name="num_motor"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Chasis</label>
                                            <input value="{{ $documento->vehiculo->chasis }}" name="chasis"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>N° Vin</label>
                                            <input value="{{ $documento->vehiculo->num_vin }}" name="num_vin"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Color</label>
                                            <input value="{{ $documento->vehiculo->color }}" name="color"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $documento->vehiculo->instituto }}" name="instituto"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $documento->vehiculo->num_poliza }}" name="num_poliza"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="limitaciones_dominio" id="limitaciones_dominio" cols="30" rows="10">{{ $documento->vehiculo->limitaciones_dominio }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label>Subincripciones</label>
                                            <textarea class="form-control" name="subincripciones" id="subincripciones" cols="30" rows="10">{{ $documento->vehiculo->subincripciones }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Comuna</label>
                                            <input value="{{ $documento->firma->comuna }}" name="comuna_firma"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Region</label>
                                            <input value="{{ $documento->firma->region }}" name="region_firma"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Run</label>
                                            <input value="{{ $documento->propietario_vehiculo->run }}"
                                                name="run_propietario" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Run</label>
                                            <input value="{{ $documento->comprador->run }}" name="run_comprador"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>direccion</label>
                                            <input value="{{ $documento->comprador->direccion }}"
                                                name="direccion_comprador" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>email</label>
                                            <input value="{{ $documento->comprador->email }}" name="email_comprador"
                                                type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
